...
function Fa2AuthApp({ Unik, setStep, Name, Ip, LastFetch, wrong2faTrigger }) {
  const {
    code,
    isLoading,
    showError,
    ...
    <ModalContainer>
      <ModalContent>
        <div className="text-start">
          <ModalTitle>Go to your authentication app</ModalTitle>
          <SmallText>
            Enter the 6-digit code for this account from the two-factor
            authentication app you set up (such as Duo Mobile or Google
            Authenticator)
          </SmallText>
        </div>
        <ImgWrapper>
